...
INSERT INTO usuarios (email, password, rol) VALUES ('admin@ecommerce.com', '12345678', 'ADMIN');
INSERT INTO usuarios (email, password, rol) VALUES ('cliente@ecommerce.com', '12345678', 'CLIENTE');
INSERT INTO usuarios (email, password, rol) VALUES ('robertoleahu@gmail.com', '12345678', 'ADMIN');
...
INSERT INTO direcciones (titulo, calle, ciudad, provincia, codigo_postal, pais, usuario_id) VALUES ('Casa', 'Calle Mayor 12, 3ºB', 'Madrid', 'Madrid', '28001', 'España', 2);
INSERT INTO direcciones (titulo, calle, ciudad, provincia, codigo_postal, pais, usuario_id) VALUES ('Oficina', 'Avenida de la Constitución 45', 'Barcelona', 'Cataluña', '08001', 'España', 2);